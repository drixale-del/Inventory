...
module.exports = function setupWindowIPC(mainWindow, ipcMain, screen) {
  ...
  const PAGE_MAP = {
    ...
    pos:        path.join(__dirname, '../../src/dashboard/cashier/sales-processing/sales-processing.html'),
    ...
    suppliers:  path.join(__dirname, '../../src/dashboard/manager/suppliers/suppliers.html'),
